    ...
    <div class="w-full sm:w-96 bg-white px-8 py-8">
        ...
        <form action="" class="flex flex-col gap-4">
            <select name="doc" class="w-full appearance-none border-b border-gray-200 bg-white pb-2 pt-1 text-base text-gray-700 focus:border-gray-900 focus:outline-none">
                ...
                <option value="cedula">CC - Cédula de Ciudadanía</option>
            ...
            <div class="relative">
                <input class="w-full appearance-none border-b border-gray-200 bg-white pb-2 pt-1 pr-8 text-base text-gray-700 focus:border-gray-900 focus:outline-none" type="password" name="password" placeholder="Contraseña" id="password">
            ...
            <button class="mt-2 w-full bg-gray-900 px-4 py-3 text-sm font-medium uppercase tracking-widest text-white cursor-pointer" type="submit">Ingresar</button>
        </form>
